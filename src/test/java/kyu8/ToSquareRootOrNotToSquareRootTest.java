...
public class ToSquareRootOrNotToSquareRootTest {
    @Test
    public void basicTests() {
        int[] input = new int[] { 4, 3, 9, 7, 2, 1 };
        int[] expected = new int[] { 2, 9, 3, 49, 4, 1 };
        assertEquals(Arrays.toString(expected), Arrays.toString(ToSquareRootOrNotToSquareRoot.squareOrSquareRoot(input)));
